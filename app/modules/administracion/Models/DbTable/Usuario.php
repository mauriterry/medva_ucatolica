...
class Administracion_Model_DbTable_Usuario extends Db_Table
{
	...
	public function insert($data){
		...
		$query = "INSERT INTO user( user_state, user_date, user_names, user_email, user_level, user_user, user_password, user_delete, user_current_user, user_code) VALUES ( '$user_state', '$user_date', '$user_names', '$user_email', '$user_level', '$user_user', '$user_password', '$user_delete', '$user_current_user', '$user_code')";
	...
	public function update($data,$id){
		...
		$user_current_user = $data['user_current_user'];
		$user_code = $data['user_code'];
		echo $query = "UPDATE user SET  user_state = '$user_state', user_names = '$user_names', user_email = '$user_email', user_level = '$user_level', user_user = '$user_user', user_delete = '$user_delete', user_current_user = '$user_current_user', user_code = '$user_code' $changepasword WHERE user_id = '".$id."'";
		$res = $this->_conn->query($query);
	}
}