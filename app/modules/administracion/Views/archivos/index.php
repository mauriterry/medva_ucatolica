        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="archivo_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'archivo_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Archivo</label>
		            ...
		            <input type="text" class="form-control" name="archivo_formato" value="<?php echo $this->getObjectVariable($this->filters, 'archivo_formato') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="archivo_dispositivo">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_archivo_dispositivo as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'archivo_dispositivo') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="archivo_sede">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_archivo_sede as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'archivo_sede') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->archivo_id; ?>
					<tr>
						<td><?=$content->archivo_nombre;?></td>
						<td><?=$content->archivo_formato;?></td>
						<td><?= $this->list_archivo_dispositivo[$content->archivo_dispositivo];?>
						<td><?= $this->list_archivo_sede[$content->archivo_sede];?>
						<td>
