<ul>
	...
	<li <?php if($this->botonpanel == 5){ ?>class="activo"<?php } ?>><a href="/administracion/archivos"><i class="fas fa-file"></i> Administrar Archivos</a></li>
	<li <?php if($this->botonpanel == 5){ ?>class="activo"<?php } ?>><a href="/administracion/graficas"><i class="fas fa-chart-pie"></i></i> Administrar Graficas</a></li>
</ul>