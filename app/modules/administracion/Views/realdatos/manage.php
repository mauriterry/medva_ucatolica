	...
	<form class="text-left" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform;?>" data-toggle="validator">
		<div class="content-dashboard">
			...
			<div class="row">
				...
				<div class="col-12 form-group">
					<label for="valDioxido"  class="control-label">Valor Dioxido</label>
					<label class="input-group">
						<div class="input-group-prepend">
				...
				<input type="hidden" name="carbonoV"  value="<?php echo $this->content->carbonoV ?>">
				<input type="hidden" name="dioxidoV"  value="<?php echo $this->content->dioxidoV ?>">
				<input type="hidden" name="ozonoV"  value="<?php echo $this->content->ozonoV ?>">
				<input type="hidden" name="rsCarbono"  value="<?php echo $this->content->rsCarbono ?>">
				<input type="hidden" name="rsDioxido"  value="<?php echo $this->content->rsDioxido ?>">
				<input type="hidden" name="rsOzono"  value="<?php echo $this->content->rsOzono ?>">
				<input type="hidden" name="ppmCarbono"  value="<?php echo $this->content->ppmCarbono ?>">
				<input type="hidden" name="ppmDioxido"  value="<?php echo $this->content->ppmDioxido ?>">
				<input type="hidden" name="ppmOzono"  value="<?php echo $this->content->ppmOzono ?>">
				<div class="col-12 form-group">
